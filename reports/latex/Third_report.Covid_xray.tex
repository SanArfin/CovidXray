...
\begin{figure}%[h!] % the [h!] helps force it "here"
    \centering
    \includegraphics[width=1.0\linewidth]{figures_report_2/gradcam_final.png}
...
\begin{figure}%[h!] % the [h!] helps force it "here"
    \centering
    \includegraphics[width=1.0\linewidth]{figures_report_2/error_analysis.png}
...
\subsubsection{Summary & Recommendations}
\begin{table}[ht]
\centering
