...
\ref{fig:SVC_2000_20x20_grid}a shows that the model has an overal accuracy of 65\%, but the prediction if class 0 (COVID) is very poor with an f1-score of only 0.29. The "normal" class could be best 
...
SVC (Bayes instead of GridSearch)\\

\textbf{4th trial } \colorbox{yellow}{ToDo Yvonne}\\
SVClinear (128 x 128, 4000 images, non augmented)\\
